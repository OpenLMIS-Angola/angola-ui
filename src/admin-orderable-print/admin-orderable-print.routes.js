...
(function() {
    ...
    function routes(modalStateProvider) {
        ...
        modalStateProvider.state('openlmis.administration.orderables.print', {
            controller: 'OrderablePrintController',
            controllerAs: 'vm',
            templateUrl: 'admin-orderable-print/orderable-print.html',
            url: '/printOrderables'
        });
    }
})();
