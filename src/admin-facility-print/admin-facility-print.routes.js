...
(function() {
    ...
    function routes(modalStateProvider) {
        ...
        modalStateProvider.state('openlmis.administration.facilities.facility.print', {
            controller: 'FacilityPrintController',
            controllerAs: 'vm',
            templateUrl: 'admin-facility-print/facility-print.html',
            url: '/printFacilities'
        });
    }
})();
