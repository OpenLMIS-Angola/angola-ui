...
(function() {
    ...
    function routes($stateProvider) {
        $stateProvider.state('openlmis.requisitions.search', {
            ...
            canAccess: function canAccess(permissionService, REQUISITION_RIGHTS) {
                return permissionService.hasRoleWithRightAndFacility(REQUISITION_RIGHTS.REQUISITION_VIEW);
            },
            controllerAs: 'vm',
            resolve: {
                facilities: function facilities(requisitionSearchService) {
                    return requisitionSearchService.getFacilities();
                },
                requisitions: function requisitions(paginationService, requisitionService, $stateParams) {
