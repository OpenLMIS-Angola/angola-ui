    ...
    function directive(jQuery, $window) {
        ...
        function link(scope, element) {
            ...
            window.requestAnimationFrame(function() {
                var isRTL = window.getComputedStyle(element[0]).direction === 'rtl';
                ...
                function blit() {
                    ...
                    if (isRTL && flexTable.length > 0) {
                        var scrollLeft = flexTable[0].scrollWidth - flexTable[0].clientWidth - flexTable[0].scrollLeft;
                        flexTable[0].scrollLeft = scrollLeft;
                    }
                }
            });
        }
